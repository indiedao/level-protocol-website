...
import CloseBoldSvg from './CloseBold.svg'
...
export const CloseBoldIcon = withSvg(CloseBoldSvg, 12, 12)
export const ZoomBoldIcon = withSvg(ZoomBoldSvg, 12, 12)
export const CollapseBoldIcon = withSvg(CollapseBoldSvg, 12, 12)
